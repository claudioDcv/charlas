angular.module('comun', [
  ...
  'ui.bootstrap', 'ui.router', 'ngRoute', 'ngAnimate', 'cl.sii.settings',
  'aaModule'
]);
...
angular
  ...
  .config(
    function($stateProvider) {
      ...
      /***********************************************************
       * Actividad por DR Ver Resultado Inscripción solo ingresa a
       * esta vista si el parametro codigo_actividad existe *
       **********************************************************/
      $stateProvider
        .state(
          'ActividadPorDRResultado', {
      ...
      $stateProvider
        .state(
          'AdminLocal', {
            url: '/admin-local',
            templateUrl: 'comun/partial/admin-local/AdminLocal/AdminLocal.html',
            controller: 'AdminLocal',
            controllerAs: 'vm'
          });
      /* Catálogo de Actividades */
      $stateProvider
        .state(
          'ActCatalogoLocal', {
            ...
            templateUrl: 'comun/partial/admin-local/ActCatalogoLocal/ActCatalogoLocal.html',
      ...
      $stateProvider
        .state(
          'ActVerLocal', {
            ...
            templateUrl: 'comun/partial/admin-local/ActVerLocal/ActVerLocal.html',
      ...
      $stateProvider
        .state(
          'ActProgNueva', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgNueva/ActProgNueva.html',
      ...
      $stateProvider
        .state(
          'ActProgActi', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgActi/ActProgActi.html',
      ...
      $stateProvider
        .state(
          'ActProgSusp', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgSusp/ActProgSusp.html',
      ...
      $stateProvider
        .state(
          'ActProgComp', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgComp/ActProgComp.html',
      ...
      $stateProvider
        .state(
          'ActProgActiVer', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgActiVer/ActProgActiVer.html',
      ...
      $stateProvider
        .state(
          'ActProgSuspVer', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgSuspVer/ActProgSuspVer.html',
      ...
      $stateProvider
        .state(
          'ActProgCompVer', {
            ...
            templateUrl: 'comun/partial/admin-local/ActProgCompVer/ActProgCompVer.html',
...
angular.module('comun').run(function($rootScope, SIISettings) {
  // SIISettings.load('sdi.lob.ss.sistemacharlas.ui',
  // 'cl.sii.sdi.lob.ss.sistemacharlas.data.impl.SettingsApplicationService/consultarParametros',
  // '/sistemacharlasui/services/data/settingsService/consultarParametros');
});
